...
def start_workflow_task(
    ...
    Args:
        ...
        metadata: Optional metadata to attach to the workflow run
...
async def _start_workflow_on_worker(
    ...
    # Merge workflow metadata with passed metadata
    run_metadata = {**(workflow_meta.metadata or {}), **(metadata or {})}
